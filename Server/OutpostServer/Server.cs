...
namespace OutpostServer
{
    internal class Server
    {
        ...
        public static void Start(int _maxPlayer, int _port)
        {
            ...
            Console.WriteLine("Starting VR Experience....");
            string? vrPath = System.Environment.ProcessPath?.Replace("OutpostServer.exe", "Windows\\OutpostHorizon.exe");
            try
            {
